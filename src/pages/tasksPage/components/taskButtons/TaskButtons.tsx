...
import { deleteTask } from 'src/store/slices';
import { useAppDispatch } from 'src/store/hooks/hooks';
import { fetchUpdateTasksPage } from 'src/store/slices/Tasks';
  ...
  return (
    <div className={styles['list-item__buttons']}>
      <button
        ...
        onClick={() => {
          dispatch(fetchUpdateTasksPage(id, { isCompleted: !isCompleted }));
        }}>
